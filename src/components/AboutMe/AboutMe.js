        ...
        <section className="aboutMe" id='AboutMe'>
            ...
            <div className="aboutMe__content__container">
                ...
                <p className='aboutMe__content--description'>
                    I am a very web programmer
                    dedicated and motivated to provide
                    solutions, applying logically and looking for consistent resolution methods. I like challenges, since they involve constant learning, be it with a paradigm shift or a new technology.</p>
