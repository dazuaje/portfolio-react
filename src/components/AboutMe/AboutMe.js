    ...
    <section className="aboutMe" id="AboutMe">
      ...
      <div className="aboutMe__content__container">
        ...
        <p className="aboutMe__content--description">
          I am web programmer dedicated and motivated to provide
        ...
        <a href="../../Assets/Curriculum David Azuaje.pdf" download>

        <button className="aboutMe__content--downloadCV">Download CV</button>
        </a>
      </div>
    </section>
  );
